...
class Repository(private val application: Application) {
    ...
    suspend fun fetchAllImages(): MutableLiveData<ArrayList<Images>> =
        withContext(Dispatchers.Main) {
            ...
            return@withContext mutableListImages
        }

    suspend fun fetchAllVideos(): MutableLiveData<ArrayList<Videos>> =
        withContext(Dispatchers.Main) {
            ...
            return@withContext mutableListVideos
        }

    suspend fun fetchAllDocs(): MutableLiveData<ArrayList<Documents>> =
        withContext(Dispatchers.Main) {
            ...
            return@withContext mutableListDocuments
        }
}